...
<div>
<button className='bg-black text-white h-[2.5rem] w-[7.5rem] rounded-lg'>New Project</button>
</div>
...
<p className='text-2xl'>Default Project</p>        
    ...
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2  font-bold tracking-tight  dark:text-black">Al Character Demo Storyboard</h5>
        </a>
        <p class="mb-3 font-normal  dark:text-gray-400">Updated 19 Mar 24</p>
     
    </div>
</div>

<div class="max-w-sm bg-[#f5f6f0]  w-[25rem] h-[20rem] flex justify-center items-center border-gray-200 rounded-lg shadow dark:border-gray-700">
<i className='text-[6rem] text-gray-400 cursor-pointer'  onClick={HandleStoryBord}> 
